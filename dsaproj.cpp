...
int abt_page()
{
    ...
    cout<<"The second one::To check the percentage of characterstics present in the particular DNA\n\n\n\n\n\n\n\n";
...
int FAQ()
{
    ...
    cout<<"It's the shape of the DNA molecule, a pair of parallel helices intertwind about a common axis.\n\n"<<endl;
...
void comparing(char D1S1[], int count1, char D2S1[], int count2)
{
    ...
    else
    {
      ...
      m=((a)/(a+b))*100;
      cout<<"\n\n \n From the comparison of the two DNA samples, it is identified that the percentage of similarity between the two DNA's are "<<m;
    }
